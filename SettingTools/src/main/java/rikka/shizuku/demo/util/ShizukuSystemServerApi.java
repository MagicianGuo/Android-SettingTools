...
public class ShizukuSystemServerApi {
    ...
    public static int PackageManager_checkPermission(String permName, String pkgName, int userId) throws RemoteException {
        return PACKAGE_MANAGER.get().checkPermission(permName, pkgName, userId);
    }

    public static void PackageManager_grantRuntimePermission(String packageName, String permissionName, int userId) throws RemoteException {
        PACKAGE_MANAGER.get().grantRuntimePermission(packageName, permissionName, userId);
    }
